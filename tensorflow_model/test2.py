...
# from  SuperAndSubPixelNet27 import superPixNet
# from  EightAndDualAttention.U_net_high_stage.U_net_high_stage_mse_smi
from simple_net_out_put import hed
test = glob.glob('/home/liu/chenhaoran/test_demo/tamper_poisson')
import os
...
if __name__ == "__main__":
    ...
    model=hed(input_shape=(320,320,3))
    model.load_weights('/home/liu/libiao/Simple_net_output/checkpoints/8.20_new_out/checkpoint.52-0.0430-0.9967-0.9529-0.8147-0.8748.hdf5',by_name=True)

    for dir_path in test:
        dir_test=os.listdir(dir_path)
        dir = dir_path.split('/')[-1]
        save_dir_path = os.path.join('/home/liu/chenhaoran/test_demo/8-10test_poisson', dir)
