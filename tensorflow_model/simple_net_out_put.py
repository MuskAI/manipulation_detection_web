...
def hed(input_shape=(320,320,3)):
    ...
    # Block 2
    x2 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block2_conv1')(x)
    ...
    # Block 3
    x3 = Conv2D(128, (3, 3), activation='relu', padding='same', name='block3_conv1')(x)
    ...
    # Block 4
    x4 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block4_conv1')(x)
    ...
    # model
    model = Model(inputs=[img_input], outputs=[ X1,X2,X3,X4,X5,X6,X7,X8,fuse,o2, o3, o4])
